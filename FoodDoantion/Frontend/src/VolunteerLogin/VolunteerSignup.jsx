...
export const VolunteerSignup = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://food-donation-project-zk5l.onrender.com/auth/volunteer-signup', {
                method: 'POST',
            ...
            if (response.ok) {
                ...
                navigate('/volunteer-login'); // Redirect to Volunteer Login page
            }
        } catch (error) {
            ...
            <div className={styles.container}>
                <div className={styles.formContainer}>
                    <form id="signupForm" className={styles.formInput} onSubmit={handleSubmit}>
                        ...
                        <p>Already have an account? <a href="/volunteer-login">Login</a></p>
                    </form>
                </div>
            </div>
